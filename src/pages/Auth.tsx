    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-accent/20 p-4">
      <div className="w-full max-w-md animate-scale-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-primary">WABA</h1>
          <p className="text-muted-foreground mt-1">WhatsApp Business CRM</p>
        </div>

        <Card className="border-panel-border shadow-lg">
            ...
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="signup">
                <form onSubmit={handleSignup} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="signup-confirm" className="flex items-center gap-1.5">
                      <Lock className="h-3.5 w-3.5" />
                      Confirm Password
                    </Label>
                    <Input
